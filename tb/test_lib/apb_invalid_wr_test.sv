class apb_invalid_wr_test extends apb_base_test;
  `uvm_component_utils(apb_invalid_wr_test)

  function new(string name = "apb_invalid_wr_test", uvm_component parent = null);
    super.new(name);
  endfunction
